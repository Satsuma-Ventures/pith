...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Crimson+Pro:ital,wght@0,200..900;1,200..900&family=Plus+Jakarta+Sans:wght@300;400;500;600&display=swap" rel="stylesheet">
...
${nav}
  ...
  return layout({
    title: atRoot ? `${p.title} — Pith — A Publication of Satsuma` : `${p.title} (${p.num}) — Pith — A Publication of Satsuma`,
